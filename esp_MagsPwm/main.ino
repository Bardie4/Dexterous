...
void setup() {
  ...
  //xTaskCreatePinnedToCore(motor1Control, "M1_ctrl", 4096, (void *)1, 1, NULL, 1);
  //xTaskCreatePinnedToCore(Motor2Control, "M2_ctrl", 4096, (void *)1, 1, NULL, 1);
  xTaskCreatePinnedToCore(motor1Scroll, "M1_scroll", 4096, (void *)1, 1, NULL, 1);
  xTaskCreatePinnedToCore(Motor2Sctroll, "M2_scroll", 4096, (void *)1, 1, NULL, 1);
...
void Motor2Sctroll(void *pvParameters) {
  uint8_t phaseShift8_120 = 256/3;
  uint8_t currentStepA = 0;
  uint8_t currentStepB = currentStepA + 85;
  uint8_t currentStepC = currentStepB + 85;
