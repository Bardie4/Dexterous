...
#ifndef FLATBUFFERS_GENERATED_FINGERBROADCAST_MY_SCHEMAS_H_
#define FLATBUFFERS_GENERATED_FINGERBROADCAST_MY_SCHEMAS_H_
...
inline flatbuffers::Offset<HandBroadcast> CreateHandBroadcastDirect(
  ...
  return my_schemas::CreateHandBroadcast(
      _fbb,
      hand__);
}
...
inline const my_schemas::HandBroadcast *GetHandBroadcast(const void *buf) {
  return flatbuffers::GetRoot<my_schemas::HandBroadcast>(buf);
}

inline const my_schemas::HandBroadcast *GetSizePrefixedHandBroadcast(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<my_schemas::HandBroadcast>(buf);
}
...
inline bool VerifyHandBroadcastBuffer(
  ...
  return verifier.VerifyBuffer<my_schemas::HandBroadcast>(HandBroadcastIdentifier());
}

inline bool VerifySizePrefixedHandBroadcastBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<my_schemas::HandBroadcast>(HandBroadcastIdentifier());
}

inline void FinishHandBroadcastBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<my_schemas::HandBroadcast> root) {
...
#endif  // FLATBUFFERS_GENERATED_FINGERBROADCAST_MY_SCHEMAS_H_
