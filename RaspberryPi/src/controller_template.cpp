#include "controllers/controller_template.h"
#include <iostream>
//Customize names that fit your implementation
void ControllerTemplate::iterateStatic(void *controller_object){
  return ((JointSpacePosController*)controller_object)->iterate();
}

ControllerTemplate::ControllerTemplate():controllerEngine(){
...
void ControllerTemplate::iterate(){
  *commandedTorque1 = *name1/900.0;
  *commandedTorque2 = *name2/900.0;
}

ControllerEngine* ControllerTemplate::getHandle(){
  return &controllerEngine;
}

void ControllerTemplate::run(){
