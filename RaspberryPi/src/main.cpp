  ...
  public:
    ...
    void* run(){
        ...
        handStates.clear();
            ...
            if (fingerMem[i].jointAngle1 < 0.3 + *zeroAngle[i][0]){              //Check if it has crossed zero point
              zeroCross[i][0] = 1;
            }else{
              zeroCross[i][0] = 0;
            }
            ...
            if (fingerMem[i].jointAngle2 < 0.3 +  *zeroAngle[i][1]){              //Check if it has crossed zero point
              zeroCross[i][1] = 1;
            }else{
              zeroCross[i][1] = 0;
            }
